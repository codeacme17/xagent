"""Tests for the provenance-safe Miro remote-MCP connector seed."""
...
def _load_migration():
    path = (
        ...
        / "src/xagent/migrations/versions/20260920_seed_miro_mcp_app.py"
    )
    spec = importlib.util.spec_from_file_location("seed_miro_migration", path)
